...
ActiveRecord::Schema.define(version: 2021_01_18_195456) do
  ...
  create_table "aci_clientes", primary_key: "id_natriff", id: :bigint, default: -> { "nextval('clientes_id_seq'::regclass)" }, force: :cascade do |t|
  ...
  create_table "aci_viajeros", primary_key: "id_viajero", id: :bigint, default: -> { "nextval('viajeros_id_viajero_seq'::regclass)" }, force: :cascade do |t|
