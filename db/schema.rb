...
ActiveRecord::Schema.define(version: 2021_01_18_195456) do
  ...
  create_table "clientes", primary_key: "id_natriff", id: :bigint, default: -> { "nextval('clientes_id_seq'::regclass)" }, force: :cascade do |t|
  ...
  create_table "forma_pagos", primary_key: "id_forma", id: :bigint, default: -> { "nextval('forma_pagos_id_seq'::regclass)" }, force: :cascade do |t|
    t.string "tipo"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "rallies", primary_key: "id_rally", id: :bigint, default: -> { "nextval('rallies_id_seq'::regclass)" }, force: :cascade do |t|
